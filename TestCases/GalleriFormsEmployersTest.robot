...
Library         DataDriver      file=datas/GalleriEmployersPageForm.csv     encoding=utf_8   dialect=unix
...
FormsTestGalleri
    ...
    FormsTestGalleri.Get EmployersPageForm validated   ${Page}  ${FirstName}  ${LastName}  ${Email}  ${Company}  ${Job}  ${Phone}  ${Employeers}  ${HeadQuarters}